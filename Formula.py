...
normal_form takes care of Diamond, or, -> and alike. Please use it when parsing formulae.
...
class Diamond(Formula):
    ...
    def normal_form(self):  # <> A = ~[]~A
        return Not(Box(Not(self.sub_formulae[0])))
